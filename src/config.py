...
FILTER_MIN_LOOKBACK_QUARTERS = 3
...
BACKTEST_RECIDIVIST_MIN_TRADES = 10  # мин. кол-во сделок для проверки на рецидивиста
BACKTEST_COMMISSION_BUY = 0.00035
BACKTEST_COMMISSION_SELL = 0.00035
BACKTEST_SLIPPAGE = 0.001  # 0.1% slippage per trade
BACKTEST_MARGIN_RATE = 0.06  # 6% годовых за кредитное плечо (SOFR + spread)

# Universe options
UNIVERSE_RUSSELL = "russell1000"
UNIVERSE_SP500 = "sp500"
DEFAULT_UNIVERSE = UNIVERSE_RUSSELL
DEFAULT_LEVERAGE = 0.0
CALC_MIN_QUARTERS = 4
