...
5. **Фильтр рецидивистов**: тикеры с >= 10 сделками и суммарным PnL < 0 исключаются (pass 1 → pass 2)
...
|---------|:-----:|:----:|:--------:|:------:|:------:|
| Fixed | 620.6% | 48.4% | 58.6% | 28.9% | 636 |
| **Compounding** | **15224.2%** | **173.6%** | **59.8%** | 35.2% | 614 |
...
Pass 1: бэктест со всеми кандидатами → выявление тикеров с >= 10 сделками и суммарным PnL < 0.
...
Текущий список (июль 2026): BG, BRBR, FDX, GGG, MRVL, MSM, MU, NFLX, PATH, ZM.
